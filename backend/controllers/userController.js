...
exports.registerUser = catchAsyncErrors(async(req,res,next)=>{
    ...
    //alternate of above commented code cuz it is already define in utils jwtToken.js file
...
exports.forgotPassword = catchAsyncErrors(async(req,res,next)=>{
    ...
    try {
        await sendEmail({
            email:user.email,
            subject:`SnatchKart Password Recovery`,
            message,
        })
        res.status(200).json({
            success:true,
...
exports.resetPassword = catchAsyncErrors(async(req,res,next)=>{
    ...
    //from above token we will find user
